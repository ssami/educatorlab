...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'mainlab_project', 'author',
        ...
        db.add_column(u'mainlab_activity', 'author',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mainlab.MyUser'], null=True, blank=True),
                      keep_default=False)
        ...
        # Adding field 'Organizer.author'
        db.add_column(u'mainlab_organizer', 'author',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mainlab.MyUser'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'mainlab_project', 'author_id')
        ...
        db.delete_column(u'mainlab_activity', 'author_id')
        ...
        # Deleting field 'Organizer.author'
        db.delete_column(u'mainlab_organizer', 'author_id')
