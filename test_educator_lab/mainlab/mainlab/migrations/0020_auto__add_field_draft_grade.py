...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Draft.grade'
        db.add_column(u'mainlab_draft', 'grade',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mainlab.Grade'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Draft.grade'
        db.delete_column(u'mainlab_draft', 'grade_id')
    ...
    models = {
        ...
        u'mainlab.draft': {
            ...
            'grade': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['mainlab.Grade']", 'null': 'True', 'blank': 'True'}),
