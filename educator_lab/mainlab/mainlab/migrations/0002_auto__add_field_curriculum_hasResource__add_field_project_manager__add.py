...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Curriculum.hasResource'
        db.add_column(u'mainlab_curriculum', 'hasResource',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Project.manager'
        db.add_column(u'mainlab_project', 'manager',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['mainlab.MyUser']),
                      keep_default=False)

        # Adding field 'Project.userModified'
        db.add_column(u'mainlab_project', 'userModified',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['mainlab.MyUser']),
                      keep_default=False)
        ...
        # Adding field 'Activity.manager'
        db.add_column(u'mainlab_activity', 'manager',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['mainlab.MyUser']),
                      keep_default=False)

        # Adding field 'Activity.userModified'
        db.add_column(u'mainlab_activity', 'userModified',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['mainlab.MyUser']),
                      keep_default=False)
        ...
        # Adding field 'Grade.hasResource'
        db.add_column(u'mainlab_grade', 'hasResource',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Subject.hasResource'
        db.add_column(u'mainlab_subject', 'hasResource',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Chapter.hasResource'
        db.add_column(u'mainlab_chapter', 'hasResource',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'MyUser.is_manager'
        db.add_column(u'mainlab_myuser', 'is_manager',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Organizer.userModified'
        db.add_column(u'mainlab_organizer', 'userModified',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['mainlab.MyUser']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'Curriculum.hasResource'
        db.delete_column(u'mainlab_curriculum', 'hasResource')

        # Deleting field 'Project.manager'
        db.delete_column(u'mainlab_project', 'manager_id')

        # Deleting field 'Project.userModified'
        db.delete_column(u'mainlab_project', 'userModified_id')

        # Deleting field 'Project.publish'
        db.delete_column(u'mainlab_project', 'publish')

        # Deleting field 'Activity.manager'
        db.delete_column(u'mainlab_activity', 'manager_id')

        # Deleting field 'Activity.userModified'
        db.delete_column(u'mainlab_activity', 'userModified_id')

        # Deleting field 'Activity.publish'
        db.delete_column(u'mainlab_activity', 'publish')

        # Deleting field 'Grade.hasResource'
        db.delete_column(u'mainlab_grade', 'hasResource')

        # Deleting field 'Subject.hasResource'
        db.delete_column(u'mainlab_subject', 'hasResource')

        # Deleting field 'Chapter.hasResource'
        db.delete_column(u'mainlab_chapter', 'hasResource')

        # Deleting field 'MyUser.is_manager'
        db.delete_column(u'mainlab_myuser', 'is_manager')

        # Deleting field 'Organizer.userModified'
        db.delete_column(u'mainlab_organizer', 'userModified_id')
